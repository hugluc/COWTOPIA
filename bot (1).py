...
while True:
    auto_upgrade_factory = input("Auto Upgrade Factory? (y/n): ").strip().lower()
    if auto_upgrade_factory in ['y', 'n']:
        break
    else:
...
while True:
    auto_buy_animal = input("Auto Buy Animal? (y/n): ").strip().lower()
    if auto_buy_animal in ['y', 'n']:
        break
    else:
        print("Invalid input. Please input 'y' or 'n'.")
        continue
        ...
        try:
            ...
            for query_data in queries:
                ...
                if auth_response:
                    ...
                    if buy_factory_response and auto_upgrade_factory == 'y':
